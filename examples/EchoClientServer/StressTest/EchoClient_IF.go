...
func (_obj *EchoClient) AddOneWayWithContext(ctx context.Context, A int32, B int32, C *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *EchoClient) SubOneWayWithContext(ctx context.Context, A int32, B int32, C *int32, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "Sub", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
