...
func (_obj *Config) ListConfigOneWayWithContext(ctx context.Context, App string, Server string, Vf *[]string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "ListConfig", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Config) LoadConfigOneWayWithContext(ctx context.Context, App string, Server string, Filename string, Config *string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "loadConfig", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Config) LoadConfigByHostOneWayWithContext(ctx context.Context, AppServerName string, Filename string, Host string, Config *string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "loadConfigByHost", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Config) CheckConfigOneWayWithContext(ctx context.Context, AppServerName string, Filename string, Host string, Result *string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "checkConfig", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Config) ListConfigByInfoOneWayWithContext(ctx context.Context, ConfigInfo *ConfigInfo, Vf *[]string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "ListConfigByInfo", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Config) LoadConfigByInfoOneWayWithContext(ctx context.Context, ConfigInfo *ConfigInfo, Config *string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "loadConfigByInfo", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Config) CheckConfigByInfoOneWayWithContext(ctx context.Context, ConfigInfo *ConfigInfo, Result *string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "checkConfigByInfo", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Config) ListAllConfigByInfoOneWayWithContext(ctx context.Context, ConfigInfo *GetConfigListInfo, Vf *[]string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "ListAllConfigByInfo", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Config) Dispatch(ctx context.Context, _val interface{}, req *requestf.RequestPacket, resp *requestf.ResponsePacket, withContext bool) (err error) {
		...
		if have {
			if ty == codec.LIST {
				...
				for i6, e6 := int32(0), length; i6 < e6; i6++ {
					...
					err = _is.Read_string(&Vf[i6], 0, false)
					if err != nil {
						return err
					}
	...
	case "loadConfig":
		...
		var Config string
		err = _is.Read_string(&Config, 4, false)
		if err != nil {
			return err
		}
	...
	case "checkConfig":
		...
		var Result string
		err = _is.Read_string(&Result, 4, false)
		if err != nil {
			return err
		}
		...
		if have {
			if ty == codec.LIST {
				...
				for i7, e7 := int32(0), length; i7 < e7; i7++ {
					...
					err = _is.Read_string(&Vf[i7], 0, false)
					if err != nil {
						return err
					}
	...
	case "loadConfigByInfo":
		...
		var Config string
		err = _is.Read_string(&Config, 2, false)
		if err != nil {
			return err
		}
	...
	case "checkConfigByInfo":
		...
		var Result string
		err = _is.Read_string(&Result, 2, false)
		if err != nil {
			return err
		}
		...
		if have {
			if ty == codec.LIST {
				...
				for i8, e8 := int32(0), length; i8 < e8; i8++ {
					...
					err = _is.Read_string(&Vf[i8], 0, false)
					if err != nil {
						return err
					}
