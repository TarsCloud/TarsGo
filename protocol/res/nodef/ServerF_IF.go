...
func (_obj *ServerF) KeepAliveOneWayWithContext(ctx context.Context, ServerInfo *ServerInfo, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "keepAlive", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *ServerF) ReportVersionOneWayWithContext(ctx context.Context, App string, ServerName string, Version string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "reportVersion", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
