...
func (obj *PropertyF) ReportPropMsg(statmsg map[StatPropMsgHead]StatPropMsgBody, opts ...map[string]string) (ret int32, err error) {
	...
	err = obj.servant.TarsInvoke(tarsCtx, 0, "reportPropMsg", buf.ToBytes(), statusMap, contextMap, resp)
	if err != nil {
		return ret, err
	}
...
func (obj *PropertyF) ReportPropMsgOneWayWithContext(tarsCtx context.Context, statmsg map[StatPropMsgHead]StatPropMsgBody, opts ...map[string]string) (ret int32, err error) {
	...
	resp := new(requestf.ResponsePacket)
	err = obj.servant.TarsInvoke(tarsCtx, 1, "reportPropMsg", buf.ToBytes(), statusMap, contextMap, resp)
	if err != nil {
		return ret, err
	}
	...
	case "reportPropMsg":
		...
		if tarsReq.IVersion == basef.TARSVERSION {
			...
			for i5, e5 := int32(0), length; i5 < e5; i5++ {
				...
				err = k5.ReadBlock(readBuf, 0, false)
				if err != nil {
					return err
				}
