...
//FindSubsetConfigById is the proxy function for the method defined in the tars file, with the context
func (_obj *QueryF) FindSubsetConfigById(id string, conf *endpointf.SubsetConf, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(tarsCtx, 0, "findSubsetConfigById", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
//FindSubsetConfigByIdWithContext is the proxy function for the method defined in the tars file, with the context
func (_obj *QueryF) FindSubsetConfigByIdWithContext(tarsCtx context.Context, id string, conf *endpointf.SubsetConf, _opt ...map[string]string) (ret int32, err error) {
...
//FindSubsetConfigByIdOneWayWithContext is the proxy function for the method defined in the tars file, with the context
func (_obj *QueryF) FindSubsetConfigByIdOneWayWithContext(tarsCtx context.Context, id string, conf *endpointf.SubsetConf, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(tarsCtx, 1, "findSubsetConfigById", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
type _impQueryF interface {
	...
	FindSubsetConfigById(id string, conf *endpointf.SubsetConf) (ret int32, err error)
}
type _impQueryFWithContext interface {
	...
	FindSubsetConfigById(tarsCtx context.Context, id string, conf *endpointf.SubsetConf) (ret int32, err error)
}
...
func (_obj *QueryF) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	...
	case "findSubsetConfigById":
		var id string
		var conf endpointf.SubsetConf
		...
		if _withContext == false {
			_imp := _val.(_impQueryF)
			_funRet_, err = _imp.FindSubsetConfigById(id, &conf)
		} else {
			_imp := _val.(_impQueryFWithContext)
			_funRet_, err = _imp.FindSubsetConfigById(tarsCtx, id, &conf)
		}
		...
		if tarsReq.IVersion == basef.TARSVERSION {
			...
			_os.Reset()
			err = conf.WriteBlock(_os, 0)
			if err != nil {
				return err
			}

			_tupRsp_.PutBuffer("conf", _os.ToBytes())
