	...
	if ty == codec.LIST {
		...
		*activeEp = make([]endpointf.EndpointF, length)
		for i1, e1 := int32(0), length; i1 < e1; i1++ {
			...
			err = (*activeEp)[i1].ReadBlock(readBuf, 0, false)
			if err != nil {
				return ret, err
			}
	...
	if ty == codec.LIST {
		...
		*inactiveEp = make([]endpointf.EndpointF, length)
		for i2, e2 := int32(0), length; i2 < e2; i2++ {
			...
			err = (*inactiveEp)[i2].ReadBlock(readBuf, 0, false)
			if err != nil {
				return ret, err
			}
	...
	if ty == codec.LIST {
		...
		*activeEp = make([]endpointf.EndpointF, length)
		for i3, e3 := int32(0), length; i3 < e3; i3++ {
			...
			err = (*activeEp)[i3].ReadBlock(readBuf, 0, false)
			if err != nil {
				return ret, err
			}
	...
	if ty == codec.LIST {
		...
		*inactiveEp = make([]endpointf.EndpointF, length)
		for i4, e4 := int32(0), length; i4 < e4; i4++ {
			...
			err = (*inactiveEp)[i4].ReadBlock(readBuf, 0, false)
			if err != nil {
				return ret, err
			}
	...
	if ty == codec.LIST {
		...
		*activeEp = make([]endpointf.EndpointF, length)
		for i5, e5 := int32(0), length; i5 < e5; i5++ {
			...
			err = (*activeEp)[i5].ReadBlock(readBuf, 0, false)
			if err != nil {
				return ret, err
			}
	...
	if ty == codec.LIST {
		...
		*inactiveEp = make([]endpointf.EndpointF, length)
		for i6, e6 := int32(0), length; i6 < e6; i6++ {
			...
			err = (*inactiveEp)[i6].ReadBlock(readBuf, 0, false)
			if err != nil {
				return ret, err
			}
	...
	if ty == codec.LIST {
		...
		*activeEp = make([]endpointf.EndpointF, length)
		for i7, e7 := int32(0), length; i7 < e7; i7++ {
			...
			err = (*activeEp)[i7].ReadBlock(readBuf, 0, false)
			if err != nil {
				return ret, err
			}
	...
	if ty == codec.LIST {
		...
		*inactiveEp = make([]endpointf.EndpointF, length)
		for i8, e8 := int32(0), length; i8 < e8; i8++ {
			...
			err = (*inactiveEp)[i8].ReadBlock(readBuf, 0, false)
			if err != nil {
				return ret, err
			}
	...
	if ty == codec.LIST {
		...
		*activeEp = make([]endpointf.EndpointF, length)
		for i9, e9 := int32(0), length; i9 < e9; i9++ {
			...
			err = (*activeEp)[i9].ReadBlock(readBuf, 0, false)
			if err != nil {
				return ret, err
			}
	...
	if ty == codec.LIST {
		...
		*inactiveEp = make([]endpointf.EndpointF, length)
		for i10, e10 := int32(0), length; i10 < e10; i10++ {
			...
			err = (*inactiveEp)[i10].ReadBlock(readBuf, 0, false)
			if err != nil {
				return ret, err
			}
