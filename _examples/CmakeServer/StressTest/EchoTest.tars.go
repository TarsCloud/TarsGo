...
func (_obj *EchoTest) EchoOneWayWithContext(ctx context.Context, SIn []int8, SOut *[]int8, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(ctx, 1, "echo", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *EchoTest) TarsSetProtocol(p m.Protocol) {
		...
		if have {
			if ty == codec.LIST {
				...
				for i3, e3 := int32(0), length; i3 < e3; i3++ {
					...
					err = _is.Read_int8(&SOut[i3], 0, false)
					if err != nil {
						return err
					}
