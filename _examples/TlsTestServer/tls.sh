...
openssl req -x509 -new -nodes -key ca.key -days 1024 -out ca.crt \
  -subj "/C=CN/ST=BeiJing/L=BJ/O=Tars/OU=TarsGo/CN=ca/emailAddress=tars@tarsgo.com"

# server
openssl genrsa -out server.key 2048
openssl req -new -key server.key -out server.csr \
  -subj "/C=CN/ST=BeiJing/L=BJ/O=Tars/OU=TarsGo/CN=server/emailAddress=tars@tarsgo.com"\
...
openssl req -new -key client.key -out client.csr \
  -subj "/C=CN/ST=BeiJing/L=BJ/O=Tars/OU=TarsGo/CN=client/emailAddress=tars@tarsgo.com"
